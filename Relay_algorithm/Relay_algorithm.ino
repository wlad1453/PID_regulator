...
{ 
  ...
  Heater.temp = averT.Average(sensors.getTempC(tSensor));    // Measurement
  Heater.switchOn = relayControl(Heater);                     // Object value evaluation
  digitalWrite( RELAY_PIN, Heater.switchOn );                 // Object control
